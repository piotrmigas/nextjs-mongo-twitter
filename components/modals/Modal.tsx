...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, onSubmit, title, body, actionLabel, footer, disabled }) => {
  ...
  return (
    <div
      onClick={handleClose}
      className='justify-center items-center flex overflow-x-hidden overflow-y-hidden fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-70'
    >
      <div
      ...
      >
        <div className='h-full lg:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-black outline-none focus:outline-none'>
          <div className='flex items-center justify-between p-10 rounded-t'>
            ...
            <button className='p-1 ml-auto border-0 text-white hover:opacity-70transition' onClick={handleClose}>
